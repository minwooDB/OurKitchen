...
public class KitchenController {
	...
	/*
	 * @GetMapping("/kitchen/search") public String
	 * moveKitchenSearch(@RequestParam(value = "keyword") String keyword, Model
	 * model) { List<KitchenDto>kitchenDtoList =
	 * kitchenService.getKitchenList(keyword); }
	 */
	
	@PostMapping("kitchen/search")
	public String selectKitchenInfo(KitchenDto kitchenDto) {
		log.info("----------sec");
		return "/kitchen/search/result";
	}
}